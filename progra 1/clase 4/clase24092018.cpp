...
int main() {//() decimos que el metodo main no recibe parametros
	...
	system("color f0");//le cambiamos color al fondo de la consola y al texto
	Beep(899,877);//ejecutamos un sonido
	pedirNum();//llamamos la funcion
...
void pedirNum()
{
	...
	float res;//aqui se almacenara el valor de la operacion
	 ...
	 cout << "ingrese un numero" << endl;//le pedimos al usuario que ingrese el primer numero
	 cin >> x;
